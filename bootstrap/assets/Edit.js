...
import { c as cn, a as addDays, i as isNotEmpty } from "./utils.js";
import { Textarea } from "@headlessui/react";
import { usePage, useForm, router } from "@inertiajs/react";
import { format } from "date-fns";
import { CalendarIcon } from "lucide-react";
import React__default, { useState, useEffect, useCallback } from "react";
import { d as defaultDiscount, e as editBreadcrumbs, p as paymentTerms } from "./constants.js";
...
function Edit({
  ...
  const initialAsInvoiceForm = () => {
    const _invoice = {
      header: {
        customer: invoice.header.customer,
        date: new Date(invoice.header.date),
        due: invoice.header.due_on ? new Date(invoice.header.due_on) : void 0,
  ...
  const [invoiceForm, setInvoiceForm, removeInvoiceForm] = usePersistedState("invoice_edit", initialAsInvoiceForm(), true);
  ...
  const composeSubTotal = invoiceForm.lines.filter((line) => line.action !== "deleted").reduce((acc, line) => {
    return acc + line.amount;
  }, 0);
  const composeTax = invoiceForm.lines.filter((line) => line.action !== "deleted").reduce((acc, line) => {
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { user: auth.user, breadcrumbs: editBreadcrumbs, children: [
    /* @__PURE__ */ jsx(AppLayout.Actions, { children: /* @__PURE__ */ jsxs("div", { className: "flex justify-end gap-x-6", children: [
      ...
      /* @__PURE__ */ jsx(Button, { onClick: handleCheckout, disabled: processing, children: invoiceForm.header.terms === 1 ? t("global.actions.checkout") : t("global.actions.update") })
    ] }) }),
    /* @__PURE__ */ jsxs("div", { className: "grid h-full w-full grid-cols-12 grid-rows-[auto_1fr_auto] gap-y-4 bg-gray-50/10", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
              ...
              /* @__PURE__ */ jsxs(
                Select,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx(SelectTrigger, { className: "w-full", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select terms" }) }),
                    /* @__PURE__ */ jsx(SelectContent, { className: "", children: tax_receipts.map((receipt) => /* @__PURE__ */ jsx(SelectItem, { value: String(receipt.id), children: receipt.name }, receipt.id)) })
                  ]
                }
              ),
      ...
      /* @__PURE__ */ jsx("div", { className: "col-span-12 min-h-48", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-y-2", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-12", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "col-span-2 flex flex-col gap-y-2 rounded-lg border border-gray-300/25 bg-gray-100/10", children: /* @__PURE__ */ jsxs("div", { className: "grid place-content-end gap-y-4 p-2", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex w-60 items-center justify-between", children: [
            /* @__PURE__ */ jsx("span", { className: "block text-base", children: t("global.discount") }),
      ...
      /* @__PURE__ */ jsx(AlertDialog, { open: openCancelConfirmation, onOpenChange: setCancelConfirmation, children: /* @__PURE__ */ jsxs(AlertDialogContent, { children: [
        ...
        /* @__PURE__ */ jsxs(AlertDialogFooter, { children: [
          /* @__PURE__ */ jsx(AlertDialogCancel, { children: t("invoices.confirmsCancelation.cancel") }),
