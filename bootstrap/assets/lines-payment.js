...
import { getColumns } from "./columns-definitions5.js";
...
const List = ({ data, rowSelection, setRowSelection, onSelectPaymentLine: onSelectPayment, onValueChange, onSelectionChange }) => {
  var _a;
  ...
  const table = useReactTable({
    ...
    meta: {
      updateData: (inputId, rowIndex, columnId, value) => {
        onValueChange == null ? void 0 : onValueChange(inputId, value);
      }
    },
    state: {
      sorting,
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "rounded-md border [&_[data-type=number]]:text-right", children: /* @__PURE__ */ jsxs(Table, { children: [
