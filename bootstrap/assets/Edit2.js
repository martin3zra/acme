...
import { m as mapPaymentLineToReceivableInvoice } from "./index13.js";
...
import { e as editPaymentBreadcrumbs } from "./constants3.js";
...
function Edit({
  ...
  const [paymentForm, setPaymentForm, removePaymentForm] = usePersistedState("payment", initialAsPaymentForm(), true);
  ...
  const totalPaid = () => {
    return paymentForm.lines.filter((line) => line.action !== "deleted").reduce((acc, line) => {
  ...
  const onSelectPaymentLine = (line, action) => {
    if (action !== "trash") return;
    const index = paymentForm.lines.findIndex((l) => l.uuid === line.uuid);
    if (index === -1) return;
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { user: auth.user, breadcrumbs: editPaymentBreadcrumbs, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid h-full w-full grid-cols-12 grid-rows-[auto_1fr_auto] gap-y-4 bg-gray-50/10", children: [
                ...
                /* @__PURE__ */ jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxs(
                  Button,
                  {
                    ...
                    children: [
                      ...
                      paymentForm.header.date ? format(paymentForm.header.date, "PPP") : /* @__PURE__ */ jsx("span", { children: "Pick a date" })
                    ]
                  }
                ) }),
      ...
      /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsx(
        List,
        {
          data: paymentForm.lines.filter((line) => (line == null ? void 0 : line.action) !== "deleted"),
          rowSelection,
          setRowSelection,
          onSelectPaymentLine,
      ...
      /* @__PURE__ */ jsx(AlertDialog, { open: openCancelConfirmation, onOpenChange: setCancelConfirmation, children: /* @__PURE__ */ jsxs(AlertDialogContent, { children: [
        ...
        /* @__PURE__ */ jsxs(AlertDialogFooter, { children: [
          /* @__PURE__ */ jsx(AlertDialogCancel, { children: t("payments.confirmsCancelation.cancel") }),
