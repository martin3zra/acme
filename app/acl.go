...
var groupedPermissions = map[string]map[string][]string{
	"owner": {"*": {"*"}},
	"admin": {
		"view":    {"dashboard", "invoice", "estimate", "order", "customer", "item", "payment", "reports", "setting", "template"},
		"viewAny": {"dashboard", "invoice", "estimate", "order", "customer", "item", "payment", "reports", "setting", "template"},
		"create":  {"dashboard", "invoice", "estimate", "order", "customer", "item", "payment", "reports", "setting", "template"},
		"delete":  {"dashboard", "invoice", "estimate", "order", "customer", "item", "payment", "reports", "setting", "template"},
		"update":  {"dashboard", "invoice", "estimate", "order", "customer", "item", "payment", "reports", "setting", "company:sequence", "template"},
		"manage":  {"template"},
	},
	"supervisor": {
		"view":    {"dashboard", "customer", "item", "payment", "reports", "template"},
		"viewAny": {"dashboard", "invoice", "estimate", "order", "customer", "item", "payment", "reports", "template"},
		"create":  {"dashboard", "invoice", "estimate", "order", "customer", "item", "payment", "reports", "template"},
		"delete":  {"dashboard", "invoice", "estimate", "order", "customer", "item", "payment", "reports", "template"},
		"update":  {"dashboard", "invoice", "estimate", "order", "customer", "item", "payment", "reports", "template"},
		"manage":  {"template"},
	},
	"standard": {
		"view":   {"invoice", "customer", "template"},
		"create": {"invoice"},
	},
}
