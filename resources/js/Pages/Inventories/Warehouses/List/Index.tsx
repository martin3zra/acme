...
import { Verb, Warehouse } from '@/types';
import {
  ColumnFiltersState,
  flexRender,
  getCoreRowModel,
...
type Props = {
  data: Warehouse[];
  onSelectWarehouse: (warehouse: Warehouse, action: Verb) => void;
};

export const List: FC<Props> = ({ data, onSelectWarehouse }) => {
  ...
  const columns = getColumns({ onDidClick: onSelectWarehouse, t });
