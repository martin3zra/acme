...
import { onValueChangeType, PayableVerb, VendorPaymentTotals } from '@/types';
import {
  ColumnFiltersState,
  flexRender,
  getCoreRowModel,
...
type Props = {
  ...
  onSelectPayableLine: (payableForm: PayableLineRow, action: PayableVerb) => void;
...
export const List: FC<Props> = ({
  ...
  const columns = getColumns({ totals, onDidClick: onSelectPayableLine, t });

  const table = useReactTable({
    data,
    columns,
    getRowId: (row: PayableLineRow) => row.id.toString(),
