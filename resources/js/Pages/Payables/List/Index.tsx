...
import { Payable, PayableVerb } from '@/types';
import {
  ColumnFiltersState,
  flexRender,
  getCoreRowModel,
...
type Props = {
  data: Payable[];
  onSelectPayable: (payable: Payable, action: PayableVerb) => void;
};

export const List: FC<Props> = ({ data, onSelectPayable }) => {
  ...
  const columns = getColumns({ onDidClick: onSelectPayable, t });
