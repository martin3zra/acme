...
import { Expense, PaymentVerb } from '@/types';
import {
  ColumnFiltersState,
  flexRender,
  getCoreRowModel,
...
type Props = {
  data: Expense[];
  onSelectExpense: (Expense: Expense, action: PaymentVerb) => void;
};

export const List: FC<Props> = ({ data, onSelectExpense }) => {
  ...
  const columns = getColumns({ onDidClick: onSelectExpense, t });
